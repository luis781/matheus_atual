...
// Mock de avaliações (substituir por fetch/backend no futuro)
const mockAvaliacoes = [
  {
    ...
    numero: '9',
    posicao: 'Atacante',
    atributos: {}, // pode preencher se quiser
  },
  {
    id: '2',
    data: '2024-03-15',
...
export function EditarAvaliacao() {
  ...
  // Estado para todos os atributos (mock: tudo N/D)
    ...
    <div className="min-h-screen bg-gray-50 py-10 px-2">
      {tab === 'dados' && (
        <div className="max-w-2xl w-full mx-auto bg-white rounded-xl shadow-lg p-4 md:p-8 lg:p-12 px-2 md:px-8 lg:px-12">
          <h1 className="text-3xl font-bold text-gray-900 mb-2 text-center">Editar Avaliação</h1>
